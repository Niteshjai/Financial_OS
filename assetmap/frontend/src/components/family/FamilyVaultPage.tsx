  ...
  if (!vault) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Family Vault</h2>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">{vault.vault_name}</h2>
          <p className="text-black/60 mt-1">Manage your shared family finances</p>
        </div>
